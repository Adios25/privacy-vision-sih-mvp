...
const javascriptFiles = ['background.js', 'browser_api.js', 'content.js', 'geometry.js', 'ocr.js', 'popup.js', 'overlayCanvas.js', 'redactionMerger.js', 'qrDetector.js', 'shadowWalker.js', 'indiaPiiValidator.js', 'zxing-browser.min.js'];
